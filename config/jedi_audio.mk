...
ALARM_PATH := vendor/jedi/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/jedi/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/jedi/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/jedi/prebuilt/common/media/audio/ui
